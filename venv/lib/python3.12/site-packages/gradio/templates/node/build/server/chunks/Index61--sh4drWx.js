import { c as create_ssr_component, v as validate_component, s as subscribe, a as createEventDispatcher, e as escape, b as add_attribute, f as each, h as setContext, m as missing_component, o as onDestroy, n as null_to_empty, i as get_store_value } from './ssr-ByKBC7Hy.js';
import { t as tick } from './Component-CveiYa-n.js';
import { B as Block, S as Static, H as MarkdownCode, N as Check, K as Copy, F as FullscreenButton, Z as Checkbox } from './2-DLkr5FwY.js';
import { d as dequal$1 } from './index8-BTEzKViK.js';
import { w as writable } from './index-CxqVvn4_.js';
import { d as dequal } from './index7-sfNUnwRZ.js';
import { U as Upload } from './ModifyUpload-D5bFiDyZ.js';
import Index$1 from './Index26-ymEQyVq4.js';
export { default as BaseExample } from './Example8-CQi9rL_X.js';
import 'tty';
import 'path';
import 'url';
import 'fs';
import './ImagePreview-CE6xfNvA.js';
import './Example11-COKkp33w.js';
...
const TableHeader = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.filter_columns === void 0 && $$bindings.filter_columns && filter_columns !== void 0)
    $$bindings.filter_columns(filter_columns);
  if ($$props.latex_delimiters === void 0 && $$bindings.latex_delimiters && latex_delimiters !== void 0)
    $$bindings.latex_delimiters(latex_delimiters);
  if ($$props.line_breaks === void 0 && $$bindings.line_breaks && line_breaks !== void 0)
    $$bindings.line_breaks(line_breaks);
  ...
  do {
    ...
    $$rendered = `<th${add_attribute(
      ...
      "svelte-41hbvn",
      (i < actual_pinned_columns ? "pinned-column" : "") + " " + (i === actual_pinned_columns - 1 ? "last-pinned" : "") + " " + (header_edit === i || selected_header === i ? "focus" : "") + " " + (sort_index !== -1 ? "sorted" : "") + " " + (filter_index !== -1 ? "filtered" : "")
    ].join(" ").trim()}"><div class="cell-wrap svelte-41hbvn"><div class="header-content svelte-41hbvn"><button class="header-button svelte-41hbvn"${add_attribute("title", value, 0)}>${validate_component(EditableCell, "EditableCell").$$render(
      $$result,
      {
        max_chars,
        latex_delimiters,
      ...
      {}
    )} ${sort_index !== -1 ? `<div class="sort-indicators svelte-41hbvn"><span class="sort-arrow svelte-41hbvn">${current_direction === "asc" ? `${validate_component(SortArrowUp, "SortArrowUp").$$render($$result, { size: 12 }, {}, {})}` : `${validate_component(SortArrowDown, "SortArrowDown").$$render($$result, { size: 12 }, {}, {})}`}</span> ${sort_columns.length > 1 ? `<span class="sort-priority svelte-41hbvn">${escape(sort_priority)}</span>` : ``}</div>` : ``} ${filter_index !== -1 ? `<div class="filter-indicators svelte-41hbvn"><span class="filter-icon svelte-41hbvn">${validate_component(CellMenuIcons, "CellMenuIcons").$$render($$result, { icon: "filter" }, {}, {})}</span></div>` : ``}</button> ${is_static ? `${validate_component(Padlock, "Padlock").$$render($$result, {}, {}, {})}` : ``}</div> ${can_add_columns ? `${validate_component(CellMenuButton, "CellMenuButton").$$render(
      $$result,
      {
...
const CellMenu = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.on_filter === void 0 && $$bindings.on_filter && on_filter !== void 0)
    $$bindings.on_filter(on_filter);
  if ($$props.on_clear_filter === void 0 && $$bindings.on_clear_filter && on_clear_filter !== void 0)
    $$bindings.on_clear_filter(on_clear_filter);
  if ($$props.filter_active === void 0 && $$bindings.filter_active && filter_active !== void 0)
    $$bindings.filter_active(filter_active);
  if ($$props.editable === void 0 && $$bindings.editable && editable !== void 0)
    $$bindings.editable(editable);
  if ($$props.i18n === void 0 && $$bindings.i18n && i18n !== void 0)
    $$bindings.i18n(i18n);
  ...
  do {
    ...
    $$rendered = ` <div class="table-container svelte-1vwr9xf">${label && label.length !== 0 && show_label || show_fullscreen_button || show_copy_button || show_search !== "none" ? `<div class="header-row svelte-1vwr9xf">${label && label.length !== 0 && show_label ? `<div class="label svelte-1vwr9xf"><p class="svelte-1vwr9xf">${escape(label)}</p></div>` : ``} ${validate_component(Toolbar, "Toolbar").$$render(
      ...
      $$result,
      {
        ...
        filter_active: active_header_menu ? $df_state.filter_state.filter_columns.some((c) => c.col === (active_header_menu?.col ?? -1)) : null
      },
      {},
      {}
    )}` : ``}`;
...
//# sourceMappingURL=Index61--sh4drWx.js.map
