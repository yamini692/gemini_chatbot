import { c as create_ssr_component, v as validate_component, b as add_attribute, m as missing_component, a as createEventDispatcher } from './ssr-ByKBC7Hy.js';
import { B as Block, S as Static, j as BlockLabel, J as File$1, n as Empty, U as UploadText, o as IconButtonWrapper, q as IconButton, P as Undo, u as Download } from './2-DLkr5FwY.js';
import { U as Upload, M as ModifyUpload } from './ModifyUpload-D5bFiDyZ.js';
export { default as BaseExample } from './Example19-ChhbuRRh.js';
...
async function loadCanvas3D$1() {
  const module = await import('./Canvas3D-DsU_0ib7.js');
  return module.default;
}
async function loadCanvas3DGS$1() {
  const module = await import('./Canvas3DGS-c6UdhlPf.js');
  return module.default;
}
const Model3D = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `${validate_component(BlockLabel, "BlockLabel").$$render(
      ...
      {},
      {}
    )} ${value ? `<div class="model3D svelte-1mxwah3" data-testid="model3d">${validate_component(IconButtonWrapper, "IconButtonWrapper").$$render($$result, {}, {}, {
      default: () => {
...
//# sourceMappingURL=Index56-Z9sizsdW.js.map
