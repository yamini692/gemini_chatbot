import { SvelteComponent, init, safe_not_equal, svg_element, claim_svg_element, children, detach, attr, insert_hydration, append_hydration, noop, tick, assign, element, create_component, space, claim_element, claim_component, claim_space, set_attributes, toggle_class, mount_component, set_input_value, action_destroyer, listen, prevent_default, transition_in, group_outros, transition_out, check_outros, get_spread_update, is_function, destroy_component, run_all, createEventDispatcher, beforeUpdate, onMount, afterUpdate, text, claim_text, set_data, ensure_array_like, set_style, destroy_each, binding_callbacks, bind, add_flush_callback, bubble, flush, get_spread_object } from "../../../svelte/svelte.js";
import "../../../svelte/svelte-submodules.js";
import { z as BlockTitle, V as convert_html_attributes, r as Clear, W as Send, X as Square, v as Image, B as Block, S as Static } from "./2.DU5PbPFs.js";
import { F as File } from "./File.DqOJDDoa.js";
import { M as Microphone } from "./SelectSource.DXcGcY1j.js";
import { M as Music } from "./Music.BKn1BNLT.js";
import { V as Video } from "./Video.CzEOFOtQ.js";
import { a as Upload } from "./Upload.Df9b3gJ6.js";
import { I as InteractiveAudio } from "./InteractiveAudio.BAobS4dq.js";
import { default as default2 } from "./Example.OGhIv4lv.js";
...
function create_fragment$1(ctx) {
  ...
  let textarea_levels = [
    ...
    {
      style: textarea_style_value = /*text_align*/
  ...
  return {
    ...
    h() {
      ...
      ctx[9]);
      toggle_class(textarea, "svelte-5gfv2q", true);
    ...
    p(ctx2, dirty) {
      ...
      set_attributes(textarea, textarea_data = get_spread_update(textarea_levels, [
        ...
        ctx2[13] ? "rtl" : "ltr")) && { dir: textarea_dir_value },
        (!current || dirty[0] & /*placeholder*/
        32) && { placeholder: (
          /*placeholder*/
          ctx2[5]
        ) },
        (!current || dirty[0] & /*lines*/
        8) && { rows: (
          /*lines*/
          ctx2[3]
        ) },
...
function instance$1($$self, $$props, $$invalidate) {
  ...
  let { html_attributes = null } = $$props;
  ...
  $$self.$$set = ($$props2) => {
    ...
    if ("html_attributes" in $$props2)
      $$invalidate(47, html_attributes = $$props2.html_attributes);
    if ("dragging" in $$props2)
      $$invalidate(1, dragging = $$props2.dragging);
  };
  $$self.$$.update = () => {
    if ($$self.$$.dirty[1] & /*html_attributes*/
    65536) {
      $$invalidate(30, html_attrs = convert_html_attributes(html_attributes));
    }
    ...
    131072) {
      if (oldValue !== value.text) {
        dispatch("change", value);
        $$invalidate(48, oldValue = value.text);
      }
    }
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      33554432)
        ...
        ctx2[25];
      if (dirty[0] & /*html_attributes*/
      134217728)
        multimodaltextbox_changes.html_attributes = /*html_attributes*/
        ctx2[27];
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      268435456)
        ...
        ctx2[28] ? "focus" : "base";
      if (dirty[0] & /*file_types, root, label, info, show_label, lines, rtl, text_align, waveform_settings, gradio, max_lines, placeholder, submit_btn, stop_btn, autofocus, autoscroll, file_count, sources, interactive, max_plain_text_length, html_attributes, value, value_is_output, dragging, active_source, loading_status*/
      2147459015 | dirty[1] & /*$$scope*/
      16777216) {
...
function instance($$self, $$props, $$invalidate) {
  ...
  onMount(() => {
    ...
    $$invalidate(30, waveform_settings.waveColor = waveform_options.waveform_color || "#9ca3af", waveform_settings);
    $$invalidate(30, waveform_settings.progressColor = waveform_options.waveform_progress_color || color_accent, waveform_settings);
    $$invalidate(30, waveform_settings.mediaControls = waveform_options.show_controls, waveform_settings);
    $$invalidate(30, waveform_settings.sampleRate = waveform_options.sample_rate || 44100, waveform_settings);
  });
  ...
  $$self.$$set = ($$props2) => {
    ...
    if ("waveform_options" in $$props2)
      $$invalidate(31, waveform_options = $$props2.waveform_options);
    if ("html_attributes" in $$props2)
      $$invalidate(27, html_attributes = $$props2.html_attributes);
  };
  $$invalidate(30, waveform_settings = {
    height: 50,
    barWidth: 2,
    barGap: 3,
    cursorWidth: 2,
...
class Index extends SvelteComponent {
  ...
  set html_attributes(html_attributes) {
    this.$$set({ html_attributes });
    flush();
  }
}
export {
