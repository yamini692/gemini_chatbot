import { c as create_ssr_component, v as validate_component, a as createEventDispatcher, e as escape, b as add_attribute, o as onDestroy } from './ssr-ByKBC7Hy.js';
import { B as Block, S as Static, j as BlockLabel, X as Code$2, n as Empty, q as IconButton, K as Copy$1, D as DownloadLink, u as Download$1, o as IconButtonWrapper, Y as getWorkerProxyContext } from './2-DLkr5FwY.js';
import Example from './Example6-CCSV4Q_z.js';
...
const lang_map = {
  python: () => import('./index32-B4OctrXM.js').then((m) => m.python()),
  ...
  markdown: async () => {
    const [md, frontmatter] = await Promise.all([
      import('./index33-B3gpH_Wt.js'),
      import('./frontmatter-Crw1xFwr.js')
    ]);
  ...
  json: () => import('./index37-BWCcahxI.js').then((m) => m.json()),
  html: () => import('./index34-CxpnznG8.js').then((m) => m.html()),
  css: () => import('./index35-g41cSGaP.js').then((m) => m.css()),
  javascript: () => import('./index36-FVZOg29G.js').then((m) => m.javascript()),
  jinja2: () => import('./jinja2-BxhAu_54.js').then(
    (m) => StreamLanguage.define(m.jinja2)
  ),
  typescript: () => import('./index36-FVZOg29G.js').then(
...
//# sourceMappingURL=Index16-BPS_NBU9.js.map
