import { c as create_ssr_component, v as validate_component, a as createEventDispatcher, b as add_attribute, e as escape, f as each, k as spread, l as escape_attribute_value, p as escape_object } from './ssr-ByKBC7Hy.js';
import { B as Block, S as Static, as as convert_html_attributes, W as BlockTitle, O as Clear, G as Image, M as Music, at as Video, J as File$1, au as Paperclip, av as Microphone, aw as Send, ae as Square } from './2-DLkr5FwY.js';
import { U as Upload } from './ModifyUpload-D5bFiDyZ.js';
import { I as InteractiveAudio$1 } from './InteractiveAudio-JEH1dQ9d.js';
export { default as BaseExample } from './Example20-BPqQIhMx.js';
...
import './AudioPlayer-DXdrvXjP.js';
import './hls-CrxM9YLy.js';
import './Video-BuDzK8YZ.js';
...
const MultimodalTextbox = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.html_attributes === void 0 && $$bindings.html_attributes && html_attributes !== void 0)
    $$bindings.html_attributes(html_attributes);
  ...
  do {
    ...
    $$rendered = `<div class="${["full-container svelte-5gfv2q", dragging ? "dragging" : ""].join(" ").trim()}" role="group" aria-label="Multimedia input field"${add_attribute("this", full_container, 0)}>${validate_component(BlockTitle, "BlockTitle").$$render($$result, { show_label, info, rtl }, {}, {
      ...
      {}
    )} <button data-testid="upload-button" class="upload-button svelte-5gfv2q" ${disabled ? "disabled" : ""}>${validate_component(Paperclip, "Paperclip").$$render($$result, {}, {}, {})}</button>` : ``} ${sources && sources.includes("microphone") ? `<button data-testid="microphone-button" class="${["microphone-button svelte-5gfv2q", ""].join(" ").trim()}" ${disabled ? "disabled" : ""}>${validate_component(Microphone, "Microphone").$$render($$result, {}, {}, {})}</button>` : ``}  <textarea${spread(
      [
        { "data-testid": "textbox" },
        { class: "scroll-hide" },
        {
          dir: escape_attribute_value(rtl ? "rtl" : "ltr")
        },
        {
          placeholder: escape_attribute_value(placeholder)
        },
        { rows: escape_attribute_value(lines) },
        { disabled: disabled || null },
        { autofocus: autofocus || null },
        {
          style: escape_attribute_value(text_align ? "text-align: " + text_align : "")
        },
        escape_object(html_attrs)
      ],
      {
        classes: (!show_label ? "no-label" : "") + " svelte-5gfv2q"
      }
...
//# sourceMappingURL=Index43-C-myzTN3.js.map
