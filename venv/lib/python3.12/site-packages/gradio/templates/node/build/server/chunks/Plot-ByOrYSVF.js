import { c as create_ssr_component, a as createEventDispatcher, v as validate_component, m as missing_component } from './ssr-ByKBC7Hy.js';
import { n as Empty, ay as Plot$1 } from './2-DLkr5FwY.js';
...
const Plot = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  const plotTypeMapping = {
    plotly: () => import('./PlotlyPlot-D7Xe6BDE.js'),
    bokeh: () => import('./BokehPlot-D3krJo-A.js'),
    altair: () => import('./AltairPlot-EBDdOpZT.js'),
    matplotlib: () => import('./MatplotlibPlot-Dd4uKL1v.js')
  };
...
//# sourceMappingURL=Plot-ByOrYSVF.js.map
