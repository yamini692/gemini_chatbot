import { c as create_ssr_component, v as validate_component, e as escape, b as add_attribute } from './ssr-ByKBC7Hy.js';
import { B as Block, S as Static, W as BlockTitle } from './2-DLkr5FwY.js';
  ...
  return `${validate_component(Block, "Block").$$render(
    ...
    {},
    {
      default: () => {
        ...
        })} <input${add_attribute("aria-label", label, 0)} type="number"${add_attribute("min", minimum, 0)}${add_attribute("max", maximum, 0)}${add_attribute("step", step, 0)}${add_attribute("placeholder", placeholder, 0)} ${disabled ? "disabled" : ""} class="svelte-7ha85a"${add_attribute("value", value, 0)}></label>`;
      }
    }
  )}`;
});
...
//# sourceMappingURL=Index28-DALe59ht.js.map
