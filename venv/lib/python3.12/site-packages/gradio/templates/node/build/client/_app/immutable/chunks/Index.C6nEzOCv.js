...
import { B as Block, x as Textbox, S as Static } from "./2.DU5PbPFs.js";
import { default as default2 } from "./Example.BXIJZ1MA.js";
...
function create_default_slot(ctx) {
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      67108864)
        textbox_changes.html_attributes = /*html_attributes*/
        ctx2[26];
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      8192)
        ...
        ctx2[13];
      if (dirty[0] & /*label, info, show_label, lines, type, rtl, text_align, max_lines, placeholder, submit_btn, stop_btn, show_copy_button, autofocus, container, autoscroll, max_length, html_attributes, interactive, value, value_is_output, gradio, loading_status*/
...
function instance($$self, $$props, $$invalidate) {
  ...
  $$self.$$set = ($$props2) => {
    ...
    if ("html_attributes" in $$props2)
      $$invalidate(26, html_attributes = $$props2.html_attributes);
  };
  return [
    value,
    value_is_output,
